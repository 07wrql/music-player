...
#define _USE_LFN     1    /* 0 to 3 — 启用长文件名支持中文 */
#define _MAX_LFN     80   /* Maximum LFN length (12-255), 80足够歌名 */
...
#define _LFN_UNICODE    0 /* 0:ANSI/OEM(GbK) or 1:Unicode — char* API 用 GBK */
...
#define _FS_REENTRANT    0  /* 0:Disable or 1:Enable — 仅 SD_Task 访问, 无需重入 */

#define _FS_TIMEOUT      1000 /* Timeout period in unit of time ticks */
//#define _SYNC_t          osSemaphoreId_t  /* 不需要: _FS_REENTRANT=0 */
